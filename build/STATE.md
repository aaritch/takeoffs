...
- **Last updated:** 2026-06-15, aarit — `@takeoff/ui` design system scaffolded (tokens, cn, Button/Card/Badge/Stack, shipped CSS) and wired into the app shell. 130 tests green; `next build` consumes it.
