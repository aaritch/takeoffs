...
- **Last updated:** 2026-06-15, aarit — added `/dev/ui` component gallery (renders every @takeoff/ui primitive + tokens) for visual review. 132 tests green; `next build` includes the static route.
